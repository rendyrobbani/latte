package com.rendyrobbani.latte.infra.persistence.entity.base.master.program;
...
public abstract class MasterProgramEntity extends BaseEntity implements MasterProgram {
	...
	protected MasterProgramEntity(LocalDateTime createdAt, NIP createdBy) {
