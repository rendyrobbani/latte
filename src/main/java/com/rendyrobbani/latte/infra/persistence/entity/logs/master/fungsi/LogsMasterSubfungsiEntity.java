...
@Data
@Entity
@Table(name = LogsMasterSubfungsiTable.NAME)
@EqualsAndHashCode(callSuper = true)
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class LogsMasterSubfungsiEntity extends MasterSubfungsiEntity implements LogsMasterSubfungsi {
	...
	private DataMasterSubfungsiEntity subject;
	...
	public LogsMasterSubfungsiEntity(LocalDateTime loggedAt, NIP loggedBy, DataMasterSubfungsiEntity subject) {
