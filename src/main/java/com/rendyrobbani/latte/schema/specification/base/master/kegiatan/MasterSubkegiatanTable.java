package com.rendyrobbani.latte.schema.specification.base.master.kegiatan;
...
public final class MasterSubkegiatanTable {
	...
	public static List<Column> getColumns() {
		if (columns == null) {
			...
			columns.add(LatteColumnFactory.createSubkegiatanCode("code", false));
